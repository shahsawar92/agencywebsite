  ...
  return (
    <>
      ...
      {/* <!-- Services Section Five --> */}
          ...
          <section className="services-section-five " style={{background:"#282828"}}>
            <div className="auto-container">
            ...
            <Tab.Content>
              ...
              <section className="pb-5 pt-5" style={{background:"black"}}>
                  ...
                  <div className="col-lg-6">
                    <div className="content pl-lg-4">
                      <div className="sec-title">
                        <div className="sub-title">Free Zones</div>
                        <h2 className="text-white">About Free Zones</h2>
                      </div>
                      <div className="text">
              ...
              <section className="section-guidance pt-5 pb-5" style={{background:"#282828"}}>
                <div className="col-lg-12 text-center auto-container">
                    <div className="content">
                      <div className="sec-title">
                        <div className="sub-title">Free Zones</div>
                        <h2 style={{color:"#d1d1d1"}}>Advantages:</h2>
                      </div>
                      <ul className="list-group list-group-flush">
                        <li className="list-group-item" style={{background:"#282828", color:"#d1d1d1"}}>100% Ownership</li>
                        <li className="list-group-item" style={{background:"#282828", color:"#d1d1d1"}}>
              ...
              <section style={{background:"#000000"}} className="pb-5 pt-5" >
                <div className="row align-items-center auto-container">
                  <div className="col-lg-12">
                    <div className="content ">
                      <div className="sec-title">
                        <div className="sub-title mt-lg-5">Free Zones</div>
                        {/* <h2 className="text">
              ...
              <section className=" pb-5 pt-5 " style={{background:"#282828"}}>
                  <div className="sortable-masonry auto-container">
                    <div className="">
                      <div className="sec-title light text-center">
                        <div className="sub-title">UAE Free Zones</div>
                        <h2>List of UAE free zones</h2>
                      </div>
                          ...
                          <div className="content ">
                            <Tab.Container defaultActiveKey="first">
                              ...
                              <li 
                                  ...
                                  style={{ cursor: "pointer", backgroundColor:"#000000",color:"#d1d1d1"}}
                                >
                                  <div
                                    id="zone0"
                                    onClick={(e) => {
                            ...
                            >
                              ...
                              >
                                <div className="card-body " style={{backgroundColor:"black", color:"#d1d1d1", border:"none"}}>
              ...
              <Tab.Pane eventKey="second" className=" fadeInUp animated">
                <section  className="pb-5 pt-5 " style={{background:"#282828"}}>
                    <div className="row align-items-center auto-container">
                      ...
                      <div className="col-lg-6">
                        <div className="content pl-lg-4">
                          <div className="sec-title">
                            <div className="sub-title">Mainland</div>
                            <h2 style={{color:"#ffffff"}}>Mainland Company Setup</h2>
                          </div>
                          <div className="text">
                ...
                <section className="pb-5 pt-5 " style={{background:"#000000"}}>
                    <div className="col-lg-12 text-center auto-container">
                      <div className="content">
                      <div className="sec-title">
                            <div className="sub-title">About</div>
                          <h3 style={{color:"#ffffff"}}>Department of Economic Development – Dubai (DED):</h3>
                        </div>
                       <div>
                ...
                <section className="pb-5 pt-5 " style={{background:"#000000"}}>
                    <div className="col-lg-12 text-center auto-container">
                      ...
                      <div className="sec-title">
                        ...
                        <ul className="list-group list-group-style">
                          <li className="list-group-item">100% Ownership</li>
                ...
                <section className="pt-5 pb-5 our-blog p-0 m-0 bg-silver" style={{backgroundColor:"#282828"}}>
                      <div className="container work-process  pb-5 pt-5">
                        <div className="title mb-5 text-center">
                          <h3>
                            Our <span className="text-white">Trade license Process </span>
                          </h3>
                        </div>
                ...
                <section className="pb-5 pt-5 mb-5" style={{background:"#282828"}}>
                    <div className="col-lg-12 auto-container">
                      <div className="content ">
                      <div className="sec-title">
                            <div className="sub-title">Activities</div>
                          <h3 style={{ color: "white" }}>License types and activities:</h3>
                        ...
                        <div className=" ">
                          <div className="card border-muted mb-3 "  style={{backgroundColor:"#282828"}}
                          >
                          
                            <div className="card-body text-white" >
                              <h3 className="card-title">Industrial License</h3>
                              <h5>
                              ...
                              <ul className="list-group mt-3 item-1" >
                                <li className="list-group-item">
                          ...
                          <div className="card border-muted mb-3 " style={{backgroundColor:"#282828"}}>
                            ...
                            <div className="card-body text-white">
                              <h3 className="card-title">Commercial License</h3>
                              <h5>
...
<section className="pt-5 mt-0"  style={{background:"#000000"}}>
      <Brand1 />
      </section>
      <Footer />
    </>
